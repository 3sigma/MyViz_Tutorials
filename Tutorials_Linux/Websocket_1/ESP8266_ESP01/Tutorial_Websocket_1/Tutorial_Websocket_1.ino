/*
 ESP8266 (ESP01) example for MyViz tutorial 1 on Websocket communication

 Connect GPIO0 to GPIO2. GPIO0 is controlled by a switch in the MyViz dashboard.
 The value of GPIO2 is displayed on this dashboard.
...
// Switch value coming from MyViz
int onoff = 0;
...
// Send to the client the value of GPIO2 and the value of "val" received
